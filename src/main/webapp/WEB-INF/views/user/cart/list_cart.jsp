...
-->
	...
	<table class="table table-bordered table-condensed">
              ...
              <tbody>
	            	...
	            	<c:forEach var="item" items="${ Cart }">
						<tr>
		                  <td><a href="chi-tiet-san-pham/${item.value.product.id_product}"><img width="150" src="<c:url value="/assets/user/img/${item.value.product.img}" />" alt="" ></a></td>
	...
	<a href="<c:url value="/tat-ca-san-pham" />" class="shopBtn btn-large"><span class="icon-arrow-left"></span> Tiếp tục mua sắm </a>
